...
<template>
    <form @submit.prevent="register"
        class="max-w-md mx-auto border-1 border-red-200 shadow-sm hover:border-red-300 rounded p-6">
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <input type="email" id="email"
                class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-xs-light"
                v-model="form.email" placeholder="Enter Email" required />
        </div>
        <div class="mb-5">
        ...
        <button type="submit"
            ...
            new account</button>
        <RouterLink :to="{ name: 'login' }"><small class="ps-6 text-[0.7rem] text-gray-600 ">You
                have already account <small class="hover:text-red-400 text-[0.9rem] ms-2">Sign in</small></small>
        </RouterLink>
    </form>
</template>